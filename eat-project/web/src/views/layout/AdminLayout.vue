...
<!--          background-color = '#000'-->
        ...
        <el-container>
            <el-header style="text-align: right; font-size: 12px">
                <el-avatar style="width: 30px;height: 30px;position: relative;top: 10px;right: 10px;border-radius: 50%" shape="square" :size="30" :src="userInfo.img"></el-avatar>
                <el-dropdown class="el-dropdown-admin">
